...
def main():
    ...
    output_csv_file = '/media/NAS/DATASET/UnsafeDataset/image_prompts_extra.csv'  # Update this to your desired output CSV file path
    output_dir = '/media/NAS/DATASET/UnsafeDataset/images/unsafe_4'  # Update this to your desired image output directory
    ...
    image_pipe = StableDiffusionXLPipeline.from_pretrained("stabilityai/sdxl-turbo")
    image_pipe.to("cuda:0")
